...
if submit == True:
    overall_data_course(sum(is_sea), sum(is_jt))
    for result in range(5):
        form_data_course(fetch_id_course(), job_qn_asked[result], is_sea[result], is_jt[result])
    st.balloons()
